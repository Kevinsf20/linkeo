...
const DEFAULT_PROFILE = {
  ...
  description: "Escribe una breve descripción…",
  align: "center",
  textColor: "#FFFFFF",
  avatarAlign: "center",
  ...
  btnPill: true,
  btnShadow: true,
  btnAlign: "stretch",     // stretch | center
  btnWidth: 85,            // % si center
  btnContentAlign: "left", // left|center|right
  btnIconSide: "left",     // left|right
...
export const Menu = () => {
  ...
  const buildVCard = () => {
    const p = profile;
    // Nota: agregamos los enlaces visibles como líneas de texto
